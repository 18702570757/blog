<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.blog.dao.*,com.blog.entity.*,com.blog.servicesImpl.*"%>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
 	<%
		...
		if (id != null || !id.equals("")) {
			...
			Article ar = new ArticleServiceImpl().selectById(aid);
			session.setAttribute("Article", ar);
		}
	%>
	
	<form class="form form-horizontal" action="../ArticleServlet" method="post">
	<input type="hidden" value="updateAll" name="flag">
	<input type="hidden" value="<%=request.getParameter("id")%>" name="aid">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${sessionScope.Article.atitle} " placeholder="" id="atitle" name="atitle">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="abstracts" cols=""  id="summary" rows="" class="textarea"  placeholder="${sessionScope.Article.asummary}" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<textarea id="editor" name="context"  class="textarea">
				${sessionScope.Article.acontent}
				</textarea>
			</div>
		</div>
		<div class="row cl">
